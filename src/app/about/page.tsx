  ...
  return (
    <div className="w-full items-center justify-center lg:flex flex-col lg:pw-24 m-10 mb-5 overlay">
      ...
      <p className="text-base mt-4 text-black font-bold p-1">
        Everyone&apos;s Radio is an open-source community standing at the intersection of music and technology. Our mission is to foster community-led innovation by prioritizing shared experiences over individual preferences through open-source technology.
